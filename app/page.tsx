          ...
          <div className="">
             <div className="flex items-center justify-between py-1">
               <div className="flex items-center gap-1">
                 <div className="w-[14px] h-[14px] rounded orange-gradient border mr-2"></div>
             ...
             <div className="flex items-center justify-between py-1">
               <div className="flex items-center gap-1">
                 <div className="w-[14px] h-[14px] rounded red-gradient border mr-2"></div>
                 <span className="text-p text-grey-500 font-light">
                   Paramount Animation
                 </span>
               </div>
             ...
             <div className="flex items-center justify-between py-1">
               <div className="flex items-center gap-1">
                 <div className="w-[14px] h-[14px] rounded violet-gradient border mr-2"></div>
                 <span className="text-p text-grey-500 font-light">
                   Target
                 </span>
               </div>
             ...
             <div className="flex items-center justify-between py-1">
               <div className="flex items-center gap-1">
                 <div className="w-[14px] h-[14px] rounded blue-gradient border mr-2"></div>
                 <span className="text-p text-grey-500 font-light">
                   The Agency at UF
                 </span>
               </div>
